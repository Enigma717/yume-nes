...
void test_asl_zpg_behaviour()
{
    ...
    MY_ASSERT(bus.ram->memory_read(0x24) == target_result);
}
...
void test_dec_zpg_behaviour()
{
    ...
    MY_ASSERT(bus.ram->memory_read(0x29) == target_result);
}
...
void test_inc_zpg_behaviour()
{
    ...
    MY_ASSERT(bus.ram->memory_read(0x2B) == target_result);
}
...
void test_lsr_zpg_behaviour()
{
    ...
    MY_ASSERT(bus.ram->memory_read(0x2F) == target_result);
}
...
void test_rol_zpg_behaviour_with_carry()
{
    ...
    MY_ASSERT(bus.ram->memory_read(0xFE) == target_result);
}
...
void test_rol_zpg_behaviour_without_carry()
{
    ...
    MY_ASSERT(bus.ram->memory_read(0xFD) == target_result);
}
...
void test_ror_zpg_behaviour_with_carry()
{
    ...
    MY_ASSERT(bus.ram->memory_read(0xFC) == target_result);
}
...
void test_ror_zpg_behaviour_without_carry()
{
    ...
    MY_ASSERT(bus.ram->memory_read(0xFB) == target_result);
}
...
void test_stx_zpg_behaviour()
{
    ...
    MY_ASSERT(bus.ram->memory_read(0xF7) == target_result);
}
