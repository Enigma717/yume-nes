...
void test_asl_abs_behaviour()
{
    ...
    MY_ASSERT(nes.cpu.memory_read(0x6424) == target_result);
}
...
void test_dec_abs_behaviour()
{
    ...
    MY_ASSERT(nes.cpu.memory_read(0x6929) == target_result);
}
...
void test_inc_abs_behaviour()
{
    ...
    MY_ASSERT(nes.cpu.memory_read(0x6B2B) == target_result);
}
...
void test_rol_abs_behaviour_with_carry()
{
    ...
    MY_ASSERT(nes.cpu.memory_read(0xCEFE) == target_result);
}
...
void test_rol_abs_behaviour_without_carry()
{
    ...
    MY_ASSERT(nes.cpu.memory_read(0xCDFD) == target_result);
}
...
void test_ror_abs_behaviour_with_carry()
{
    ...
    MY_ASSERT(nes.cpu.memory_read(0xCCFC) == target_result);
}
...
void test_ror_abs_behaviour_without_carry()
{
    ...
    MY_ASSERT(nes.cpu.memory_read(0xCBFB) == target_result);
}
...
void test_sta_abs_behaviour()
{
    ...
    MY_ASSERT(nes.cpu.memory_read(0xC8F8) == target_result);
}
...
void test_stx_abs_behaviour()
{
    ...
    MY_ASSERT(nes.cpu.memory_read(0xC7F7) == target_result);
}
...
void test_sty_abs_behaviour()
{
    ...
    MY_ASSERT(nes.cpu.memory_read(0xC6F6) == target_result);
}
